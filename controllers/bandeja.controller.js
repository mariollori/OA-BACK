...
const  nodemailer = require('nodemailer');
  ...
  const get_asignaciones_pendientes = async (req, res) => {
     try{
  ...
  const get_paciente_data = async (req, res) => {
  try{
 ...
 const get_personal_data = async (req, res) => {
  try{
 ...
 const update_asignacion__de_personal = async (req, res) => {
  try{
...
async function enviarmensaje(destino){
 ...
 module.exports= {get_asignaciones_pendientes,get_paciente_data,get_personal_data,update_asignacion__de_personal}
