const { pool } = require('../database')
 ...
 const getpac_asignados = async(req,res)=>{
    ...
    try {
     ...
     const get_paciente_info = async(req,res)=>{
 ...
 const get_atenciones_registradas = async(req,res)=>{
 ...
 const registrar_primera_atencion=async(req,res)=>{
 ...
 const registrar_atencion=async(req,res)=>{
 ...
 const finalizar_atencion = async (req, res) => {
    try {
        var f = new Date();
        const  idasignacion = req.params.id
 ...
 const derivar_externo = async (req, res) => {
    try {
        var f = new Date();
        const  idasignacion = req.params.id
        const motivo = req.body.motivo;
 ...
 const cancelar_atencion = async (req, res) => {
    try {
        var f = new Date();
        const  idasignacion = req.params.id;
        const motivo = req.body.motivo;
 ...
 const derivar_atencion_inmediata = async (req, res) => {
    try {
        var f = new Date();
 ...
 const get_historial = async(req,res)=>{
    const idpaciente = req.params.id;
    try {
        const response = await pool.query(
...
module.exports={
cancelar_atencion,derivar_atencion_inmediata,derivar_externo,finalizar_atencion,get_atenciones_registradas,get_historial,get_paciente_info,getpac_asignados,registrar_atencion,registrar_primera_atencion,registrar_puntuacion
}
