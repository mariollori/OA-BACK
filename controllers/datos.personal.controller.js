const  {pool} = require('../database')
 ...
 const createDatoPsicologos = async (req, res) => {
    try {
 ...
 const updatedataschool = async (req, res) => {
    try {
 ...
 const  gethorariospsicologo = async (req, res) => {
    try {
        const id = req.params.id;
...
//  const  get_estudiantes_5toaño = async (req, res) => {
//     try {
