...
// <<------------------------OPCIONES------------------>>
 ...
 const get_opciones_por_rol = async (req, res) => {
    try {
        const opciones = [];
 ...
 const asignaropc_rol = async (req, res) => {
    try {
 ...
 const listaropcid = async (req, res) => {
    try {
        const id = req.params.id
...
// <<------------------------ROLES------------------>>
 ...
 const asignarrol_user = async (req, res) => {
    try {
...
// <<---------------------ROLES - OPCIONES - DIFERENTES------------------------------------->>
 ...
 const listaropcdisponibles = async (req, res) => {
    try {
 ...
 const listarusuariospertenecientes = async (req, res) => {
    try {
        const id = req.params.id
...
// <<<------------------- USUARIO ------------------------->>>
 const desactivar_usuario = async(req,res)=>{
    try {
 ...
 const activar_usuario = async(req,res)=>{
    try {
        const idusuario = req.params.id;
 ...
 const listarusuarios_tipo = async (req, res) => {
    try {
 ...
 const listaropcionesderol = async (req, res) => {
    try {
        const id = req.params.id
 ...
 const eliminaropcionderol = async (req, res) => {
    try {
...
modificarrol,
listarrolid,
listaropcdisponibles,
listarusuariosdisponibles,
listarusuariospertenecientes,
asignarrol_user,
listarusuarios,
listarusuarios_tipo,
listaropcionesderol,
